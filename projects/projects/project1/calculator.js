...
async function calculator() {
    ...
    while (condition) {
        ...
        if (operation === "additon") {
            console.log(`the sum of given values is ${addition(num1, num2)}`);
        }
        else if (operation === "subtraction") {
            console.log(`the subtraction of given values is ${subtraction(num1, num2)}`);
        }
        else if (operation === "multiplication") {
            console.log(`the multiple of given values is ${multiplication(num1, num2)}`);
        }
        else if (operation === "division") {
            console.log(`the division of given values is ${division(num1, num2)}`);
        }
